...
namespace Drupal\url_alteration\Entity;
 ...
 *   label = @Translation("Custom Group relationship"),
 ...
 *     "create-form" = "/group/{group}/{plugin_id}",
 *     "create-page" = "/group/{group}/create",
 ...
 * )
 */
class CustomGroupRelationship extends GroupRelationship implements GroupRelationshipInterface {
