...
class FindYourHouse extends BlockBase
{
	...
	public function build()
	{
		...
		$build = [
			...
			'#markup' => '<div class="select-menu"><div class="select-btn"><span class="sBtn-text" role="button" tabindex="0">Select your House Name</span><div class="select-arrow" aria-label="Select dropdown" role="button" tabindex="0" aria-pressed="false" tabindex="0"></div><ul class="options">' . $options_html . '</ul></div></div>',
